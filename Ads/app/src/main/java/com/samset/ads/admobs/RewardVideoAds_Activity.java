...
public class RewardVideoAds_Activity extends AppCompatActivity implements RewardedVideoAdListener{

    private static final String AD_UNIT_ID = "ca-app-pub-8158315839737160/8530290131";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reward_video_ads_);
